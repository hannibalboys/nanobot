...
export type SettingsNavItem = { key: SettingsSectionKey; icon: LucideIcon; fallback: string };
...
export function visibleSettingsNavItems(settings: SettingsPayload | null): SettingsNavItem[] {
