...
const LOCALIZED_SETTINGS_COPY_KEYS = [
  ...
  "settings.devices.online",
  "settings.devices.offline",
  "settings.devices.lastSeen",
  "settings.devices.sharedRoots",
  "settings.devices.confirmRevoke",
  "settings.devices.revoke",
  "settings.devices.wizardTitle",
  "settings.devices.step1",
  "settings.devices.step1desc",
  "settings.devices.step2",
  "settings.devices.codeExpired",
  "settings.devices.codeExpires",
  "settings.devices.regenerate",
  "settings.devices.step3",
  "settings.devices.pairedOnline",
  "settings.devices.waitingOnline",
  "settings.devices.loadingDownloads",
  "settings.devices.downloadFor",
  "settings.devices.allReleases",
  "settings.devices.sourceInstall",
  "settings.devices.copyInstall",
  "settings.devices.copiedInstall",
  "settings.devices.loading",
  "settings.devices.done",
  "sidebar.automations",
  ...
  "settings.values.themeDefault",
  "settings.values.themeForest",
...
describe("webui i18n", () => {
  ...
  it("keeps Simplified Chinese settings overview copy localized", () => {
    ...
    expect(settings.nav.devices).toBe("设备");
