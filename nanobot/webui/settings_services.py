...
from nanobot.config.loader import config_file_lock, load_config, save_config
...
class WebUISettingsConfig:
    ...
    def __init__(self, config_path: Path) -> None:
        ...
        # Shares save_config()'s per-path lock instance so nested saves within
        # run_serialized()/update() re-enter instead of deadlocking.
        self._file_lock = config_file_lock(self.path)
